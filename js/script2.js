...
$(document).ready(function(){
  ...
  function selected_data_type(item){
    ...
    li_html += '<option value="dropdown" '+if_selected(item, 'ref')+'>Dropdown</option>';
    li_html += '<option value="text" '+if_selected(item, 'input')+'>Text</option>';
    li_html += '<option value="int" '+if_selected(item, 'number', 'int')+'>Number (without a decimal point)</option>';
    li_html += '<option value="float" '+if_selected(item, 'number', 'double')+'>Number (with a decimal point)</option>';
    li_html += '<option value="boolean" '+if_selected(item, 'ref')+'>True/false</option>';
    li_html += '<option value="date" '+if_selected(item, 'date')+'>Date</option>';
    li_html += '<option value="bucket" '+if_selected(item, 'ref')+'>Bucket</option>';
